...
num_cores = 10
gamma = np.linspace(2.05, 3.5, 30)

function_arguments = {}
function_arguments['N'] = 1000
function_arguments['m'] = 1000
function_arguments['kmin'] = 2
Nexp = 1000

# unbiased random walk with higher-order step
# check that the directories exist
save_to = 'data/pl_cardinalities/exp_urw_ho'
processed_list = Parallel(n_jobs=num_cores)(delayed(HRW.rw_on_generated_hypergraphs)(HM.Generate_PL_Hypergraph,
...
save_to = 'data/pl_cardinalities/exp_urw_p'
processed_list = Parallel(n_jobs=num_cores)(delayed(HRW.rw_on_generated_hypergraphs)(HM.Generate_PL_Hypergraph,
                                                                                     update_dict(function_arguments,'gamma',i),
                                                                                     Nexp,
                                                                                     'urw',
...
save_to = 'data/pl_cardinalities/exp_merw_ho'
processed_list = Parallel(n_jobs=num_cores)(delayed(HRW.rw_on_generated_hypergraphs)(HM.Generate_PL_Hypergraph,
                                                                                     update_dict(function_arguments,'gamma',i),
                                                                                     Nexp,
                                                                                     'merw',
...
save_to = 'data/pl_cardinalities/exp_merw_p'
processed_list = Parallel(n_jobs=num_cores)(delayed(HRW.rw_on_generated_hypergraphs)(HM.Generate_PL_Hypergraph,
                                                                                     update_dict(function_arguments,'gamma',i),
                                                                                     Nexp,
                                                                                     'merw',
